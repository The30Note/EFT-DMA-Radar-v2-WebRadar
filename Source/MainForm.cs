...
namespace eft_dma_radar
{
    public partial class frmMain : MaterialForm
    {
        ...
        private void LoadConfig()
        {
            ...
            swAimNeck.Checked = this.config.AimbotNeck;
            swAimChest.Checked = this.config.AimbotChest;
            swAimPelvis.Checked = this.config.AimbotPelvis;
            swAimRLeg.Checked = this.config.AimbotRightLeg;
        ...
        private void materialSaveBtn_Click(object sender, EventArgs e)
        {
            ...
            // Update the Config object with the new hostname
            this.config.Hostname = hostnameTextBox.Text;
            Program.Log("Hostname set to: " + config.Hostname); // Debug line
        ...
        private void SAMainForm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            this.config.SASilentAimKey = (int)e.KeyCode; // Save the keycode in your config
        ...
        {
            this.config.AimbotFOV = sldrAimbotFOV.Value;
            Config.SaveConfig(this.config);
        ...
        private void MainForm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            this.config.AimbotKeybind = (int)e.KeyCode; // Save the keycode in your config
        ...
        private void SAMainForm_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            this.config.SASilentAimKey = mouseButtonCode; // Save the mouse button code in your config
            this.KeyDown -= SAMainForm_KeyDown; // Unsubscribe from the event
            this.MouseDown -= SAMainForm_MouseDown; // Unsubscribe from MouseDown event
            Config.SaveConfig(this.config);
        }
        ...
        private void MainForm_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            this.config.AimbotKeybind = mouseButtonCode; // Save the mouse button code in your config
            this.KeyDown -= MainForm_KeyDown; // Unsubscribe from the event
            this.MouseDown -= MainForm_MouseDown; // Unsubscribe from MouseDown event
            Config.SaveConfig(this.config);
        }
